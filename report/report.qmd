...
# How we calculate taxes
 ...
 Assistance of the Policy Simulation Library’s Tax-Calculator model, a highly regarded model of the federal income tax -- [documentation](https://taxcalc.pslmodels.org/) and [code](https://github.com/PSLmodels/Tax-Calculator).

 Explain why this is a high-quality approach.


# Fake text to show how the report will look
